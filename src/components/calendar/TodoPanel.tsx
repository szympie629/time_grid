      ...
      <div className="flex gap-2 mb-3 shrink-0">
        <div className="relative flex-1">
          <input
            ...
            className={`w-full border rounded-lg px-3 py-1.5 text-xs focus:outline-none transition-colors border-b-transparent focus:border-b-transparent ${
              isLimitReached
          ...
          />
          <div 
            className={`absolute bottom-0 left-0 h-[2px] transition-all duration-300 z-10 rounded-bl-lg ${isLimitReached ? 'bg-red-500 rounded-br-lg' : 'bg-blue-500'}`} 
